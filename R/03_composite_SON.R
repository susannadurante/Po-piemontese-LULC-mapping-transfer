# Seasonal median Sentinel-2 L2A composite - autumn (SON, Sep-Nov 2019)
...
file_collection <- file.path(dir_output, "S2_SON_4tile_collection.db")
...
dir_temp <- file.path(DIR_BASE, "tmp_S2_SON")
