# Seasonal median Sentinel-2 L2A composite - winter (DJF, Dec 2018-Feb 2019)
...
file_collection <- file.path(dir_output, "S2_DJF_4tile_collection.db")
...
dir_temp <- file.path(DIR_BASE, "tmp_S2_DJF")
