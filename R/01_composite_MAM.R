# Seasonal median Sentinel-2 L2A composite - spring (MAM, Mar-May 2019)
...
file_collection <- file.path(dir_output, "S2_MAM_4tile_collection.db")
...
dir_temp <- file.path(DIR_BASE, "tmp_S2_MAM")
